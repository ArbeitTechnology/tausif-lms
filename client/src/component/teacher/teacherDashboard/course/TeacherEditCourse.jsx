...
const TeacherEditCourse = () => {
    ...
    useEffect(() => {
        const fetchCourseData = async () => {
            try {
                ...
                const response = await axios.get(`${base_url}/api/teacher/my-course/${id}`, {
                    headers: {
    ...
    const updateCourse = async () => {
        try {
            ...
            // Make API call
            const response = await axios.put(`${base_url}/api/teacher/update-course/${id}`, formData, {
                headers: {
    ...
    return (
        <div className="bg-gradient-to-br from-gray-100 p-[20px] to-gray-300 min-h-screen">
